...
class QLearningAgent(ReinforcementAgent):
    ...
    def getQValue(self, state, action):
        ...
        """
        if (state, action) not in self.seenstates:
            self.seenstates[(state, action)] = 0.0
        return self.seenstates[(state, action)] 
